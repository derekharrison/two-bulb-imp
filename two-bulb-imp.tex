...
The Maxwell-Stefan equations were solved using the finite volume method and the results were found to agree well with other numerical methods and experimental observations, thereby validating the solution. Regarding the discretization strategy, it was found that implicit time discretization is significantly more stable than an explicit scheme. 
