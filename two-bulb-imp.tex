...
\paragraph*{Results} 
The solution obtained from solving the model equations are shown in figure \ref{fig:fig_1}. The solution agrees well with experimental observations [\ref{eqn:my_ref_2}].
