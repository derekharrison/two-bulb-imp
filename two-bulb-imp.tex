...
The Maxwell-Stefan equations were solved using the finite volume method and the results were found to agree well with experimental observations, thereby validating the model. Regarding the discretization strategy, it was found that implicit time discretization is significantly more stable than an explicit scheme. 
