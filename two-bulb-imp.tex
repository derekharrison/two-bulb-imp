...
\paragraph*{Results} 
The results obtained from solving the model equations are shown in figure \ref{fig:fig_1}. The results agree well with experimental observations [\ref{eqn:my_ref_2}].
