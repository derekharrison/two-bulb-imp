...
The results obtained in this work based on implicit time discretization is compared with an approach based on explicit time discretization. Explicit time discretization was only stable for small timesteps, whereas the implicitly discretized approach was stable. Analysis of the coefficients of the linear system obtained from discretization of the model equations shows that the coefficients satisfy the Scarborough criterion, and so the matrix associated with the linear system is diagonally dominant.
